...
export const translations = {
  en: {
    ...
    mechanisticChainLabel: 'Mechanistic Chain',
    analogyMappingLabel: 'Analogy Mapping',
    sourceLabel: (title: string) => `"${title}" (Source)`,
    targetLabel: (title: string) => `"${title}" (Target)`,
    boundaryConditionsLabel: 'Boundary Conditions',
    keyDisanalogyLabel: 'Key Disanalogy',
    counterfactualLabel: 'Counterfactual',
    testablePredictionsLabel: 'Testable Predictions',
    ...
    rankingStep: '4. Ranking & Deep Synthesis Pipeline',
    // Modals
    ...
    thinkingSynthesizing: (count: number) => `Forming ${count} initial hypotheses...`,
  ...
  zh: {
    ...
    mechanisticChainLabel: '机制链',
    analogyMappingLabel: '类比映射',
    sourceLabel: (title: string) => `"${title}" (来源)`,
    targetLabel: (title: string) => `"${title}" (目标)`,
    boundaryConditionsLabel: '边界条件',
    keyDisanalogyLabel: '关键不相似点',
    counterfactualLabel: '反事实',
    testablePredictionsLabel: '可检验的预测',
    confidenceLabel: '置信度：',
    ...
    thinkingSynthesizing: (count: number) => `正在形成 ${count} 个初步假设...`,
